  ...
  return (
    <div className="flex flex-col items-center mt-6 lg:mt-20">
      ...
      <p className="mt-10 text-lg text-center text-neutral-500 max-w-4xl">
        Empower your creativity Lorem ipsum dolor sit amet consectetur
        adipisicing elit. Odio quas voluptate similique neque! Dolore porro
        illum distinctio eius magnam qui.
      </p>
